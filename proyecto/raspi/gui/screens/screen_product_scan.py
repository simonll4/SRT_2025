...
class ProductScanScreen(tk.Frame):
    ...
    def update_table(self):
        """Actualiza la tabla con los productos escaneados"""
        self.tree.delete(*self.tree.get_children())
        for p in self.scan_service.get_products():
            self.tree.insert("", "end", values=(p["name"], p["quantity"], "Precio"))
...
# import tkinter as tk
# from tkinter import ttk, messagebox
# from view_models.scan_product_service import ProductScanService
# from screens.screen_confirmation import ConfirmationScreen
