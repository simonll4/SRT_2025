...
# class IdentificationScreen(tk.Frame):
#     def __init__(self, master, on_success, on_failure, *args, **kwargs):
#         super().__init__(master, *args, **kwargs)
#         self.on_success = on_success
#         self.on_failure = on_failure
#         self.auth_service = AuthService()  # Instancia del servicio
#         self.create_widgets()
#         self.check_rfid_loop()  # Iniciar detección

#     def create_widgets(self):
#         tk.Label(self,
#                 text="Acerca su tarjeta al lector",
#                 font=("Arial", 16)).pack(pady=20)

#         self.status_label = tk.Label(self,
#                                    text="Estado: Esperando tarjeta...",
#                                    fg="gray")
#         self.status_label.pack(pady=10)

#     def check_rfid_loop(self):
#         """Verifica RFID periódicamente."""
#         user = self.auth_service.authenticate_user()

#         if user:
#             self.status_label.config(text="¡Tarjeta detectada!", fg="green")
...
#             }))
#         else:
#             self.status_label.config(text="Tarjeta no reconocida", fg="red")
#             self.after(1000, self.on_failure)

#         # Revisar cada 2 segundos
#         self.after(2000, self.check_rfid_loop)
